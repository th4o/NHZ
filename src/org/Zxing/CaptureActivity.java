...
public class CaptureActivity extends Activity implements Callback {
    ...
    static private CodeReceiver mCodeReceiver;
    public static void startScanCode(Context context, CodeReceiver codeReceiver){
        mCodeReceiver = codeReceiver;
	...
	public void handleDecode(Result obj, Bitmap barcode) {
		...
		if ( null != mCodeReceiver ){
            finish();
		    mCodeReceiver.onResult(true, obj.getText());
		    mCodeReceiver = null;
		    return;
		}
