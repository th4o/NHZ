...
public class Transaction {
    ...
    static public boolean loadTransaction(Transaction transaction){
        ...
        String httpUrl = String.format(
                "%s/nhz?requestType=getTransaction&&transaction=%s", 
        ...
        try {
            ...
            try {
                ...
                if ( NHZTransaction.TYPE_PAYMENT == transaction.mType ){
                    if ( NHZTransaction.SUBTYPE_PAYMENT_ORDINARY_PAYMENT == transaction.mSubType ){
                    ...
                    }else if ( NHZTransaction.SUBTYPE_MESSAGING_ARBITRARY_MESSAGE == transaction.mSubType ){
    ...
    static public LinkedList<Transaction> getTransactionList(
        ...
        String base_url = "http://" + ip + ":7776";
        String httpUrl = String.format(
                "%s/nhz?requestType=getAccountTransactionIds&account=%s&timestamp=%d", 
